...
import com.getallevent.exceptionhandling.InvalidCredentialException;
import com.getallevent.exceptionhandling.TokenExpiredException;
...
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if(accessToken instanceof Object) {
		System.out.println("tokenHeader from request " + accessToken.toString());
		}
		}
